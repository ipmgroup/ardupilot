...
#define BOARD_DEFAULT_SPD 5000
#define BOARD_DEFAULT_ACC 2000
#endif
...
const AP_Param::GroupInfo AP_BoardConfig::var_info[] = {
    ...
    // @RebootRequired: True
    // @User: Advanced
    AP_GROUPINFO("CANZERO_CTL", 11, AP_BoardConfig, CANZero_CTL, BOARD_DEFAULT_CTL),
    ...
    // @RebootRequired: True
    // @User: Advanced
    AP_GROUPINFO("CANZERO_SPD", 12, AP_BoardConfig, CANZero_SPD, BOARD_DEFAULT_SPD),
    ...
    // @RebootRequired: True
    // @User: Advanced
    AP_GROUPINFO("CANZERO_ACC", 13, AP_BoardConfig, CANZero_ACC, BOARD_DEFAULT_ACC),
#endif
